  ...
  new webpack.DefinePlugin({
    ...
    process: {
      env: {
        ...
        PERF_MONITOR_ENABLED: JSON.stringify(process.env.PERF_MONITOR_ENABLED || ''),
        PERF_FUNCTION_THRESHOLD_MS: JSON.stringify(process.env.PERF_FUNCTION_THRESHOLD_MS || ''),
        PERF_FUNCTION_WARN_MS: JSON.stringify(process.env.PERF_FUNCTION_WARN_MS || ''),
      },
    },
  }),
